...
role :web, "gito.com"                          # Your HTTP server, Apache/etc
role :app, "gito.com"                         # This may be the same as your `Web` server
role :db,  "gito.com"   , :primary => true # This is where Rails migrations will run
